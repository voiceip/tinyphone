...
cmd /k MKLINK /D E:\lib\curl\builds\libcurl-vc-x86-release-dll-ipv6-sspi-winssl E:\lib\curl\builds\libcurl-vc15-x86-release-dll-ipv6-sspi-winssl
ls E:\lib\curl\builds
cmd /k .\libcurl-vc15-x86-release-dll-ipv6-sspi-winssl\bin\curl.exe https://wttr.in/seattle
...
cd E:\lib\cryptopp
msbuild /m cryptest.sln -target:cryptlib:Rebuild /p:Configuration=Debug /p:Platform=Win32
